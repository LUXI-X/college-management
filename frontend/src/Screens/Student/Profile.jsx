      ...
      {data && (
        <>
          <div>
            ...
            <button
              className={`${
                showPass ? "bg-red-100 text-sky-600" : "bg-cyan-600 text-white"
            ...
            {showPass && (
              <form
                className="mt-4 border-t-2 border-cyan-500 flex flex-col justify-center items-start"
              ...
              >
                <input
                  ...
                  className="px-3 py-1 border-2 border-cyan-500 outline-none rounded mt-4"
                />
                <input
                  type="password"
                  value={password.new}
                ...
                />
                <button
                  className="mt-4 hover:border-b-2 hover:border-cyan-500"
