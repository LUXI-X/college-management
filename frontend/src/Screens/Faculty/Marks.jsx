    ...
    <div className="w-full mx-auto flex justify-center items-start flex-col my-10">
        ...
        <>
          <div className="mt-10 w-full flex justify-evenly items-center gap-x-6">
            <div className="w-full">
              ...
              <select
                id="branch"
                className="px-2 bg-blue-50 py-3 rounded-sm text-base w-full accent-cyan-700 mt-1"
          ...
          <button
            className="bg-blue-50 px-4 py-2 mt-8 mx-auto rounded border-2 border-cyan-500 text-black"
      ...
      {studentData && studentData.length !== 0 && (
        <>
            ...
            {studentData.map((student) => {
              return (
                <div
                  ...
                  className="w-[30%] flex justify-between items-center border-2 border-cyan-500 rounded"
          ...
          <button
            className="bg-cyan-500 px-6 py-3 mt-8 mx-auto rounded text-white"
