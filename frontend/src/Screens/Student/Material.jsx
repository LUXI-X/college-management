      ...
      <div className="mt-8 w-full flex justify-center items-center flex-col">
        <div className="flex justify-center items-center w-[40%]">
          <select
            ...
            className="px-2 bg-blue-50 py-3 rounded-sm text-base accent-cyan-700"
          >
          ...
          <button
            ...
            className="bg-cyan-500 text-white py-3 px-4 text-2xl rounded-sm"
          >
            <HiOutlineSearch />
          </button>
        </div>
          ...
          {material &&
            material.reverse().map((item, index) => {
              return (
                <div
                  key={index}
                  className="border-cyan-500 border-2 w-full rounded-md shadow-sm py-4 px-6 relative mb-4"
                >
                  <p
                  ...
                  >
                    {item.title}{" "}
                    {item.link && (
                      <span className="text-2xl group-hover:text-sky-400 ml-1">
                        <IoMdLink />
                      </span>
                    )}
                  </p>
